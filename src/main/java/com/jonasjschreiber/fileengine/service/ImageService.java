...
public class ImageService {
    ...
    public void uploadFile(MultipartFile file) {
        ...
        if (!ImageUtils.isAcceptableType(file.getOriginalFilename())) {
            log.error("Filetype: {} is not an acceptable type", ImageUtils.getExtensionByApacheCommonLib(file.getName()));
        ...
        try {
            ...
            if (Files.exists(Paths.get(filename))) {
                ...
                String newFilename = uploadDir + StringUtils.cleanPath(ImageUtils.getBaseNameOfFile(filename)
                        + "-" + random + "." + ImageUtils.getExtensionByApacheCommonLib(filename));
    ...
    public List<com.jonasjschreiber.fileengine.model.Image> getList() throws IOException {
        ...
        return files.stream()
                ...
                .map(f -> {
                    ...
                    com.jonasjschreiber.fileengine.model.Image image = com.jonasjschreiber.fileengine.model.Image.builder()
                            .filename(ImageUtils.getBaseNameOfFile(filename) + "." + ImageUtils.getExtensionByApacheCommonLib(filename))
